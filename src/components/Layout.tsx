...
export default function Layout({ children }: LayoutProps) {
  ...
  function handleBuyCredits() {
    alert("🛒 Buy Credits flow coming soon — Stripe checkout will open here.");
  }
      ...
      ">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6 items-center">
            ...
            {/* NEW — Credits History Link */}
            <div className="group relative">
              <Link to="/credits-history" className={linkClass("/credits-history")}>
                Credits history
              </Link>
              ...
              {notifOpen && (
                ...
                ">
                  ...
                  <div className="p-3 text-sm text-slate-300">
                    • Scan report ready<br/>
                    • Bonus credit unlocked
                  </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-white/10 bg-slate-900/80 backdrop-blur-xl">
            <nav className="flex flex-col p-3 gap-3">
              ...
              <Link to="/credits-history" onClick={() => setMenuOpen(false)}>
                Credits history
              </Link>
