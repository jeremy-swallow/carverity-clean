...
export default function UsedCarGuide() {
  useEffect(() => {
    applySeo({
      title:
        "What To Check When Buying a Used Car in Australia (What Buyers Miss) | CarVerity",
      description:
      ...
      structuredData: [
        ...
        },
        {
          ...
          mainEntity: [
            ...
            {
              "@type": "Question",
              name: "What should I check first when buying a used car?",
              acceptedAnswer: {
                "@type": "Answer",
                text:
                  "Start with the car’s history and paperwork before you become emotionally invested. A PPSR check, VIN confirmation, and service history review can rule out major issues early.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text:
                  "No. A PPSR check is important, but it does not replace a proper physical inspection, test drive, or review of the service history.",
              },
            },
          ],
        },
        ...
        <article className="space-y-12">
          <header className="space-y-4">
            ...
            <p className="text-slate-400 text-base leading-relaxed">
              Buying a used car can feel rushed. The seller is standing there,
              the test drive is short, and it is easy to forget what to look
              for once the pressure starts building.
            </p>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              ...
              <li>
                Drive the car and watch for noises, vibration or poor shifting
              </li>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Before physically viewing the vehicle, there are a few checks
              every Australian buyer should do first. This helps you avoid
              wasting time on the wrong car.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              <li>
                ...
                to see whether the car is under finance, written off, or
                recorded as stolen
              </li>
              <li>
                Confirm the VIN matches the registration and seller paperwork
              </li>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Walk around the vehicle slowly. Do not just look for obvious
              damage. Look for inconsistency. A used car can appear clean while
              still showing clues that something is off.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              ...
              <li>
                Check for rust, especially in lower sections and coastal cars
              </li>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              automatically means you should walk away, but both are worth
              taking seriously.
            </p>

            <p className="text-slate-400 leading-relaxed">
              If you want a more detailed walk-through while standing next to
              the vehicle, use our full{" "}
              <Link
            ...
            <p className="text-slate-400 leading-relaxed">
              If you want a full inspection process built around real-world
              buyer pressure, read{" "}
              <Link
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              ...
              <li>
                Test the air conditioning properly, not just for a few seconds
              </li>
            ...
            <p className="text-slate-400 leading-relaxed">
              Heavy seat, steering wheel or pedal wear on a supposedly
              low-kilometre car is worth questioning. It does not prove anything
              on its own, but it is the kind of detail buyers often regret
              ignoring later. If you are unsure how to think about odometer
              numbers more broadly, read{" "}
              <Link
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              The test drive is where a lot of useful information shows up, but
              it is also where many buyers become vague and stop checking
              systematically.
            </p>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              about price. If you need help framing that side of the decision,
              read{" "}
              <Link
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Many buyers do not miss issues because they are careless. They
              miss them because they are excited, rushed, or reassured too
              quickly by a tidy-looking car.
            </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Yes. The core inspection steps stay the same, but the risks can
              feel different depending on who is selling the car.
            </p>

            <p className="text-slate-400 leading-relaxed">
              A dealer may offer more presentation and some extra reassurance,
              but that does not remove the need for proper checks. A private
              sale can sometimes offer better value, but often gives you less
              room for comeback if something goes wrong.
            </p>

            <p className="text-slate-400 leading-relaxed">
              If you are weighing that up, compare the pros and cons in our
              guide to{" "}
              <Link
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              signs like poor history, finance concerns, repair inconsistency,
              or bad driving behaviour may justify walking away.
            </p>

            <p className="text-slate-400 leading-relaxed">
              If you are trying to work out the next step on price, read our
              guide on{" "}
              <Link
                to="/how-much-should-you-offer-used-car-australia"
                className="underline text-white hover:opacity-80 transition"
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              One of the biggest problems during a used car inspection is not
              lack of effort. It is lack of structure. Buyers often know some of
              what to look for, but they forget checks in the moment.
            </p>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              are built around that same idea: guiding buyers through the
              process calmly, helping them document what they see, and reducing
              the chance of missing something important while standing next to
              the car.
            </p>
          </section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-slate-400 leading-relaxed mt-2">
                  ...
                  emotionally invested. A PPSR check, VIN confirmation and
                  service history review can rule out major issues early.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed mt-2">
                  ...
                  proper physical inspection, test drive or review of the
                  service history.
                </p>
              </div>
